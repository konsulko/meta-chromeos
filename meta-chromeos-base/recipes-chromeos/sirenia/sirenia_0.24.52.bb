SUMMARY = "The runtime environment and middleware for ManaTEE."
...
PACKAGECONFIG[manatee] = ""
PACKAGECONFIG[sirenia] = ""

GN_ARGS += ' \
    use={ \
        cros_host=${@bb.utils.contains('PACKAGECONFIG', 'cros_host', 'true', 'false', d)} \
        manatee=${@bb.utils.contains('PACKAGECONFIG', 'manatee', 'true', 'false', d)} \
        sirenia=${@bb.utils.contains('PACKAGECONFIG', 'sirenia', 'true', 'false', d)} \
    } \
'
