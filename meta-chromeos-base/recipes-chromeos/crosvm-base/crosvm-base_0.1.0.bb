SUMMARY = "Small system utility modules for usage by other modules."
...
inherit chromeos_gn
require recipes-chromeos/chromiumos-platform/chromiumos-platform-crosvm.inc

S = "/src/platform/crosvm"
B = "${WORKDIR}/build"
PR = "r1"
