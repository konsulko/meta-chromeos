SUMMARY = "DBus Proxy Library for Biometrics Daemon for Chromium OS"
...
CHROMEOS_PN = "biod_proxy"

S = "${WORKDIR}/src/platform2/biod/${CHROMEOS_PN}"
B = "${WORKDIR}/build"
PR = "r355"

DEPENDS:append = " libbrillo system-api"

GN_ARGS += 'platform_subdir="biod/${CHROMEOS_PN}"'
