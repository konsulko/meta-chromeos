SUMMARY = "A daemon to update EC firmware of hammer, the base of the detachable."
...
PACKAGECONFIG[hammerd_api] = ""
PACKAGECONFIG[fuzzer] = ""

GN_ARGS += ' \
    use={ \
        hammerd_api=${@bb.utils.contains('PACKAGECONFIG', 'hammerd_api', 'true', 'false', d)} \
