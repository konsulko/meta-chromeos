SUMMARY = "Secure file erasure for Chrome OS"
...
do_install() {
    ...
    install -d ${D}${bindir}
    install -m 0755 ${B}/secure_erase_file ${D}${bindir}/

    install -d ${D}${includedir}/chromeos/secure_erase_file/
    install -m 0755 ${S}/secure_erase_file.h ${D}${includedir}/chromeos/secure_erase_file/
}
